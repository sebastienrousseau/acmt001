...
.. list-table::
   ...
   * - FR-102
     - ``xml/generate_xml.py``
     - ``_XML_DATA_PREPARERS`` dispatch dict
...
.. list-table::
   ...
   * - FR-208
     ...
     - ``load_csv_data_streaming()``, ``load_json_data_streaming()``,
       ...
       ``load_parquet_data_streaming()``, ``load_account_data_streaming()``
...
.. list-table::
   ...
   * - FR-501
     - ``xml/generate_xml.py``
     - ``_prepare_account_opening()`` (acmt.001, acmt.007)
     - ``test_generate_xml.py``, ``test_message_matrix.py``
   * - FR-502
     - ``xml/generate_xml.py``
   ...
   * - FR-503
     - ``xml/generate_xml.py``
     - ``_prepare_account_closing()`` (acmt.019)
     - ``test_generate_xml.py``, ``test_message_matrix.py``
   * - FR-504
     - ``xml/generate_xml.py``
     - ``_prepare_identification()`` (acmt.022, acmt.023, acmt.024)
     - ``test_generate_xml.py``, ``test_message_matrix.py``
   * - FR-505
     - ``xml/generate_xml.py``
...
.. list-table::
   ...
   * - FR-701
     ...
     - ``test_exceptions.py``, ``test_bic_validator.py``,
       ``test_iban_validator.py``, ``test_lei_validator.py``
   * - FR-702
     - ``exceptions.py``
     - ``XMLGenerationError``
...
.. list-table::
   ...
   * - NFR-502
     - ``exceptions.py``
     - ``Acmt001Error`` base class hierarchy
     - ``test_exceptions.py``
   * - NFR-503
     - ``xml/generate_xml.py``, ``constants.py``
     - ``_XML_DATA_PREPARERS`` dict, ``valid_xml_types`` list
