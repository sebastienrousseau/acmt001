...
from acmt001.exceptions import InvalidBICError
...
class TestValidateBic:
    ...
    def test_invalid_bic_strict_raises(self):
        with pytest.raises(InvalidBICError) as exc_info:
            validate_bic("INVALID", field="account_servicer_bic")
        assert exc_info.value.field == "account_servicer_bic"
...
class TestValidateBicSafe:
    ...
    def test_with_field_name(self):
        assert validate_bic_safe("COBADEFF", field="account_servicer_bic")
