...
"""JSON Schema-based validator for account management data.

This module provides schema-based validation for account data against
...
Example:
    ...
    >>>
    >>> validator = SchemaValidator("acmt.007.001.05")
...
class ValidationError:
    ...
    def __init__(
        ...
        Args:
            ...
            path: JSON path to the invalid field (e.g., "$.account_id").
...
class SchemaValidator:
    """Validates account data against JSON Schema files.
    ...
    def __init__(
        ...
        Args:
            ...
            schema_dir: Directory containing schema files. Defaults to acmt001/schemas/.
    ...
    def validate_data(self, data: dict[str, Any]) -> list[ValidationError]:
        ...
        Args:
            data: Dictionary containing account data to validate.
    ...
    def validate_batch(
        ...
        Args:
            rows: List of dictionaries containing account data.
