...
from acmt001.db.load_db_data import sanitize_table_name
...
def load_db_data_streaming(
    ...
    Example:
        >>> for chunk in load_db_data_streaming('accounts.db', 'acmt001', chunk_size=500):
        ...     # Process chunk
        ...     process_account_batch(chunk)
